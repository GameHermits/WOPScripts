...
public class TelchinesShooter : MonoBehaviour
{
	...
	// This class object to disable it self after finish

	public GameObject go_FireMetero;
	// Fire Metero Prefab Refrence
	public GameObject go_NatureRaor;
	//NatureRoar Prefab Refrence
	public GameObject go_WayHolderOne;
	//Projectile Luncher right
	public GameObject go_WayHoldertow;
	// Projectile Luncher middle
	public GameObject go_WayHolderThree;
	// Projectile Luncher left
	public GameObject go_Minion;
	// Enemy Prefab
	public GameObject go_Spawner1;
	// Enemy Spawner one
	public GameObject go_Spawner2;
	// Enemy spawner two
	public float fl_MovementForce = 50f;
	// movement force that move the projectile

	private enum enum_Attacks
	{
		NatureRaor,
		Firemeteor,
		CallToArms}
	...
	;
	// Type of Attacks
	private enum_Attacks at_attacks = enum_Attacks.NatureRaor;
	// Type of Attack
